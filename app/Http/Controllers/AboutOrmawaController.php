...
class AboutOrmawaController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!$abouts) {
            return redirect()->route('tentangkami.create'); 
        }
        return view('tentangkami.index', compact('abouts'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tentangkami.edit', compact('abouts'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('tentangkami.index')->with('success', 'Berita berhasil diperbarui.');
    }
}
