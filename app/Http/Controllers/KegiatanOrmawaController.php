...
class KegiatanOrmawaController extends Controller
{
    public function index()
    {
        ...
        return view('kegiatanormawa.index', compact('fotos'));
    }

    public function create()
    {
        return view('kegiatanormawa.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kegiatanormawa.index')->with('success', 'Foto kegiatan berhasil ditambahkan.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('kegiatanormawa.index')->with('success', 'Foto kegiatan berhasil dihapus.');
    }
}
