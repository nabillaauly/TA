<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('kegiatanukm.create') }}" class="bg-indigo-700 text-white px-4 py-2 rounded-full">
                Tambah Foto
            </a>
        </div>
    </x-slot>
                ...
                @forelse($fotos as $foto)
                    <div class="bg-white p-4 rounded shadow">
                        ...
                        <div class="flex justify-between">
                            ...
                            <form action="{{ route('kegiatanukm.destroy', $foto->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus foto ini?')">
                                @csrf
                                @method('DELETE')
