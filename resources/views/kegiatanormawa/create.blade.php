<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 bg-white p-8 shadow rounded">
            ...
            <form action="{{ route('kegiatanormawa.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                ...
                <div class="flex justify-end space-x-2">
                    <a href="{{ route('kegiatanormawa.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded">Batal</a>
